...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', 'src', 'trihex_gpt_custom'))
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', 'src', 'trihex_gpt_custom', 'modules'))
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', 'src', 'soul-diagnosis-webhook'))
...
def test_flask_app_import():
    ...
    try:
        import sys
        import os
        webhook_path = os.path.join(os.path.dirname(__file__), '..', 'src', 'soul-diagnosis-webhook')
...
def test_streamlit_app_import():
    ...
    try:
        import sys
        import os
        streamlit_path = os.path.join(os.path.dirname(__file__), '..', 'src', 'trihex_gpt_custom')
